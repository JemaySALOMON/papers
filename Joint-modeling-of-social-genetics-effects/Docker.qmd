...
Create a folder for the nalysis (e.g. `paper1-simul`) and copy the repository files/folder (as organized) into it.
...
You can check the R version and list installed packages. See the [Docker CLI reference](https://docs.docker.com/reference/cli/docker/) for more. You can also install additional packages and customize the image to suit your needs.
